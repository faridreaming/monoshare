...
export default class MonoView {
  ...
  static initMap(coords, monos = []) {
    ...
    monos.forEach((mono) => {
      const marker = L.marker([mono.lat, mono.lon], { icon: monoIcon }).addTo(
        MonoView.#map,
      ).bindPopup(`
          <div class="card bg-transparent w-full shadow-sm card-xs">
            <figure>
              <img
            ...
            <div class="card-body gap-2">
              ...
              <div class="card-actions justify-end">
                <a href="#/monos/${mono.id}" class="btn btn-primary btn-xs w-full text-primary-content!" aria-label="Selengkapnya tentang mono dari ${mono.name}">
                  Selengkapnya
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
